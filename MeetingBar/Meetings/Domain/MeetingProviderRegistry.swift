...
private extension MeetingProviderRegistry {
    // swiftlint:disable function_body_length
    static let builtIn: [MeetingProviderDescriptor] = {
        ...
        return [
            ...
            desc(.zoom,
                 icon: "zoom_icon",
                 pattern: #"https:\/\/(?:[a-zA-Z0-9-.]+)?zoom(-x)?\.(?:us|com|com\.cn|de)\/(?:my|[a-z]{1,2}|webinar)\/[-a-zA-Z0-9()@:%_\+.~#?&=\/]*"#),

            // Zoom (native app scheme)
            desc(.zoom_native,
                 icon: "zoom_icon",
                 pattern: #"zoommtg://([a-z0-9-.]+)?zoom(-x)?\.(?:us|com|com\.cn|de)/join[-a-zA-Z0-9()@:%_\+.~#?&=\/]*"#),
            ...
            desc(.teams,
                 icon: "ms_teams_icon",
                 pattern: #"https?://(gov.)?teams\.microsoft\.(com|us)/l/meetup-join/[a-zA-Z0-9_%\/=\-\+\.?]+"#),

            // Cisco Webex
            desc(.webex,
                 icon: "webex_icon",
                 pattern: #"https?://(?:[A-Za-z0-9-]+\.)?webex\.com(?:(?:/[-A-Za-z0-9]+/j\.php\?MTID=[A-Za-z0-9]+(?:&\S*)?)|(?:/(?:meet|join)/[A-Za-z0-9\-._@]+(?:\?\S*)?))"#),
            ...
            desc(.discord,
                 icon: "no_online_session",
                 pattern: #"(http|https|discord)://(www\.)?(canary\.)?discord(app)?\.([a-zA-Z]{2,})(.+)?"#),

            // Blackboard Collaborate (no custom icon)
            desc(.blackboard_collab,
                 icon: "no_online_session",
            ...
            desc(.vimeo,
                 icon: "vimeo_icon",
                 pattern: #"https://vimeo\.com/(showcase|event)/[0-9]+|https://venues\.vimeo\.com/[^\s]+"#),
            ...
            desc(.gather,
                 icon: "gather_icon",
                 pattern: #"https?://app.gather.town/app/[A-Za-z0-9]+/[A-Za-z0-9_%\-]+\?(spawnToken|meeting)=[^\s]*"#),
            ...
            desc(.streamyard,
                 ...
                 pattern: #"https://(?:www\.)?streamyard\.com/(?:guest/)?([a-z0-9]{8,13})(?:/|\?[^ \n]*)?"#),
